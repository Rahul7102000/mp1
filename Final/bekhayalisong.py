...
class bs(QMainWindow):
    ...
    def playfunction66(self):
        pygame.mixer.init()
        pygame.mixer.music.load("C:\\Users\\lenovo\\Desktop\\Rahul.G\\Python Mini Project\\Mp1\\music\\Bekhayali.mp3")
    ...
    def backhomepagefunction(self):
        sys.path.append('C:\\Users\\lenovo\\Desktop\\Rahul.G\\Python Mini Project\\Mp1\\Final\\homepage.py')
        import homepage

    def backcategoryfunction(self):
        sys.path.append('C:\\Users\\lenovo\\Desktop\\Rahul.G\\Python Mini Project\\Mp1\\Final\\categoryofsongs.py')
